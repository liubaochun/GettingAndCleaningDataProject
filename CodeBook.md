...
*  an activity label (ActivityName): WALKING, WALKING_UPSTAIRS, WALKING_DOWNSTAIRS, SITTING, STANDING, LAYING
...
The data set is written to the file activitySummary.txt.
